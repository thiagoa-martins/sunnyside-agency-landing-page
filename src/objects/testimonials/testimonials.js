...
const Testimonials = () => {
  return (
    <section className="testimonials">
      ...
      <div className="cards">
        <ClientTestimonial src={ImageEmily} alt="Emily" title="Emily">
          <p>
        ...
        <ClientTestimonial src={ImageThomas} alt="Thomas" title="Thomas">
          <p>
        ...
        <ClientTestimonial src={ImageJennie} alt="Jennie" title="Jennie">
          <p>
