  ...
  return (
    <section className="projects" id="projects">
      <div className="project graphic-design">
        ...
        <CardProject color="hsl(167, 40%, 24%)">
      ...
      <div className="project photography">
        <img src={ImagePhotography} alt="Photography" title="Photography" />

        <CardProject color="hsl(198, 62%, 26%)">
          <h3>Photography</h3>
